...
def populate_stats():
    ...
    logger.info(f"There have been {len(personal_info_response.json())} personal info logs and {len(food_log_url.json())} food logged since {current_stats['last_updated']}")
